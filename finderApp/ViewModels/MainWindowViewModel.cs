...
using finderApp.Helpers;
using finderApp.ViewModels.Base;

namespace finderApp.ViewModels
{
    /// <summary>
    ...
    public class MainWindowViewModel : BaseViewModel
    {
        ...
        /// </summary>
        private int ResizeBorder { get; set; } = 6;
